...
The user will provide a session number and title (or you can infer from context). Use the template below to create the file at `docs/sessions-recaps/session-##-short-title.md` (zero-padded number, lowercase hyphenated title).
